    ...
    <header className="sticky top-0 z-40 bg-[#f7f2e7]/95 dark:bg-[#181410]/95 backdrop-blur-md border-b border-[#d8c8b0] dark:border-[#2f271d] transition-colors duration-300 shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#d4af37] to-[#8b6222] p-[2px] shadow-md group-hover:scale-105 transition-transform duration-300">
            ...
            <div>
              <h1 className="font-cinzel text-xl sm:text-2xl font-bold tracking-tight text-[#3d2b1d] dark:text-[#f3e9d8] flex items-center gap-2">
                AANCHAL'S ART GALLERY
                <span className="text-[10px] font-sans font-medium px-2 py-0.5 rounded-full bg-[#e8dbbf] dark:bg-[#2e2318] text-[#8b6222] dark:text-[#d4af37] border border-[#c5a059]/40 uppercase tracking-widest">
                  VINTAGE
                </span>
              </h1>
              <p className="font-cormorant italic text-xs text-[#705844] dark:text-[#a89582]">
                Personal Digital Painting & Sketch Catalog • {totalArtworksCount} Items Archived
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 bg-[#eae1d0] dark:bg-[#231b14] p-1 rounded-xl border border-[#d8c8b0] dark:border-[#382b1f] shadow-inner self-center md:self-auto overflow-x-auto max-w-full">
          <button
            onClick={() => onViewChange('gallery')}
            className={`flex items-center gap-2 px-3.5 py-1.5 rounded-lg text-xs font-cinzel font-medium transition-all duration-200 whitespace-nowrap ${
              activeView === 'gallery'
          ...
          >
            ...
            <span>Saved Board ({pinnedCount})</span>
          </button>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative flex-1 md:w-52">
            ...
            <input
              type="text"
              placeholder="Search art or 001.jpg..."
              value={searchQuery}
              onChange={(e) => onSearchChange(e.target.value)}
              className="w-full pl-8 pr-3 py-1.5 text-xs bg-[#efea3f]/10 dark:bg-[#241d17] border border-[#d8c8b0] dark:border-[#3a2e22] rounded-lg text-[#3d2b1d] dark:text-[#f3e9d8] placeholder-[#947e6a] dark:placeholder-[#7a6857] focus:outline-none focus:ring-1 focus:ring-[#c5a059]"
            />
            {searchQuery && (
              <button 
          ...
          {/* Upload / Add Serial Artwork Button */}
          <button
            onClick={onOpenUpload}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gradient-to-r from-[#d4af37] to-[#b38927] hover:from-[#e5c14f] hover:to-[#c49831] text-[#17110a] text-xs font-cinzel font-bold shadow-md hover:shadow-lg transition-all duration-200 active:scale-95"
            title="Add artwork or custom serial number"
          >
